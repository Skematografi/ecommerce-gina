                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <?php
                                ...
                                {
                                    echo "<h2 style='text-align:center; margin-top:50px; margin-bottom:100px;'><i style='color:gray; padding:20px; font-size: 50pt;' class='fas fa-shopping-cart'></i><br>Keranjang kosong</h2>"; 
                                }   
                        ?>
